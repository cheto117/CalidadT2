...
namespace CalidadT2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IAppBibliotecaContext, AppBibliotecaContext>();
            services.AddTransient<IHomeRepo, HomeRepo>();
            services.AddTransient<ILibroRepo, LibroRepo>();
            services.AddTransient<IBibliotecaRepo, BibliotecaRepo>();
